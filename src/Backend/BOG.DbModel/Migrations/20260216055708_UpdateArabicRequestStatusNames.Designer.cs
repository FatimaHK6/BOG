...
namespace BOG.DbModel.Migrations
{
    ...
    [Migration("20260216055708_UpdateArabicRequestStatusNames")]
    partial class UpdateArabicRequestStatusNames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BOG.DbModel.Entities.CaseRegistration.AdditionalInfoServiceRights", b =>
                {
                    ...
                    b.ToTable("AdditionalInfoServiceRightses", (string)null);
                });
            ...
            modelBuilder.Entity("BOG.DbModel.Entities.CaseRegistration.CaseRegistrationRequest", b =>
                {
                    ...
                    b.Property<int?>("ApplyingMethodId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BOG.DbModel.Entities.CaseRegistration.CaseRequestWorkflow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CaseRequestWorkflows");
                });
            ...
            modelBuilder.Entity("BOG.DbModel.Entities.Lookups.ApplyingMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Request submitted in person at the court",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Through Court",
                            NameAr = "من خلال المحكمة"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Request submitted through the online portal",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Through Portal",
                            NameAr = "من خلال البوابة"
                        });
                });
            ...
            modelBuilder.Entity("BOG.DbModel.Entities.CaseRegistration.CaseRegistrationRequest", b =>
                {
                    b.HasOne("BOG.DbModel.Entities.Lookups.ApplyingMethod", "ApplyingMethod")
                        .WithMany()
                        .HasForeignKey("ApplyingMethodId")
                        .OnDelete(DeleteBehavior.Restrict);
